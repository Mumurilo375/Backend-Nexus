...
promotionsRouter.post("/", authMiddleware, adminMiddleware, PromotionController.create);
promotionsRouter.put("/:id", authMiddleware, adminMiddleware, PromotionController.update);
